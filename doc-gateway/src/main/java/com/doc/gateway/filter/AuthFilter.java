package com.doc.gateway.filter;

import com.doc.common.core.constant.CacheConstants;
import com.doc.common.core.constant.HttpStatus;
import com.doc.common.core.constant.SecurityConstants;
import com.doc.common.core.constant.TokenConstants;
...
import com.doc.gateway.config.properties.IgnoreWhiteProperties;
...
public class AuthFilter implements GlobalFilter, Ordered {
    ...
    public Mono<Void> filter(ServerWebExchange exchange, GatewayFilterChain chain) {
        ...
        //过滤掉websocket请求，解决网关转发websocket失败
