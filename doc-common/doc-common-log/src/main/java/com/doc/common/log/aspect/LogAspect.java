package com.doc.common.log.aspect;
...
import com.doc.common.log.enums.BusinessStatus;
import com.doc.common.log.filter.PropertyPreExcludeFilter;
import com.doc.common.log.service.AsyncLogService;
...
public class LogAspect {
    ...
    public void getControllerMethodDescription(JoinPoint joinPoint, Log log, SysOperLog sysOperLog, Object jsonResult) throws Exception {
        ...
        if (log.isSaveRequestData()) {
            // 获取参数的信息，传入到数据库中。
            setRequestValue(joinPoint, sysOperLog, log.excludeParamNames());
        }
        // 是否需要保存response，参数和值
     ...
     * @throws Exception 异常
     */
    private void setRequestValue(JoinPoint joinPoint, SysOperLog sysOperLog, String[] excludeParamNames) throws Exception {
                ...
                && (HttpMethod.PUT.name().equals(requestMethod) || HttpMethod.POST.name().equals(requestMethod)))
        {
            ...
            sysOperLog.setOperParam(StringUtils.substring(JSON.toJSONString(paramsMap, excludePropertyPreFilter(excludeParamNames)), 0, 2000));
        }
    }
